...
function plus(psid) {
    ...
    var price = $("#price" + psid).text();
   // alert(num + "|" + price + "||" + "<%=basePath%>/cart/asyUpdate?num="+num+"&price="+price);
    //var tolPrice = num*price;
    var num = $(".yzquantity" + psid).val();
    var booksId = $(".hiddenId" + psid).val();
    
    
   // alert("num:" + num + ";booksQuantity:" + booksQuantity + ";booksId:" + booksId);
    window.location.href="http://localhost:8080/cart/asyUpdate?num="+num+"&price="+price+"&booksId="+booksId;
    
    /*$.ajax(function(){
    	url: "${pageContext.request.contextPath }/cart/asyUpdate",
    	type: "POST",
    	dataType: "json",
