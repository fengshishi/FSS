...
<script type="text/javascript" src="/js/address/distpicker.data.min.js"></script>
            ...
            <ul>
                <li class="list-item active">
                    <div class="userCenter-content">
                        <h1 class="blue-line clearfix">收货地址管理</h1>
			<p class="pink-line default-pink-line">
				<span class="num"></span>
				<span class="red">  添加/修改地址    带*号的均为必填项</span>
				<button class="add-address" type="button"></button>
			</p><br><br>
			<form style="padding-left: 150px;" action="${pageContext.request.contextPath }/address/insert" method="post" onsubmit="return check()">
				<div class="address-bar">
				<p>
					收货姓名：
					<input name="addressName" type="text" id="name" class="consignee-name" data-valid-rule="length(1,20,1)" data-valid-tip="输入姓名 | 姓名格式错误"/>
					<span class="red" id="tip1">*</span> 
					<span class="inside-tip"></span>
				</p>
				
				<br><br>

				<p data-toggle="distpicker">
					收货地址： 
					<select data-province="---- 选择省 ----" name="addressProvice" id="pro"></select> 
					<select data-city="---- 选择市 ----" name="addressCity" id="city"></select> 
					<select data-district="---- 选择区 ----" name="addressXianqu" id="xq"></select> 
					<span class="red">*</span>
				</p>
				...
				<p>
					街道地址：
					<input type="text" name="addressDetail" style="width:320px;" id="diss" data-valid-rule="length(3,50,1)" data-valid-tip="请输入地址（50字以内）  | 地址错误"/> 
					<span class="red" id="tip3">*</span>
				</p>
				<br><br>
				<p>
					手机号码：
					<input type="text" name="addressPhone" id="phone" data-valid-rule="isMobile" data-valid-tip="手机号码为11位的数字 | 手机号码格式错误"/> 
					<span class="red" id="tip4">*</span>
				</p>
				...
				<p>
					<button type="button" class="button1" id="address">保存</button>
				</p>
			 </div>
			</form>
                 </div>   
