...
<div class="personal-list-item ml-10 bd-1-e8 fl" id="problem">
			...
			<p class="pink-line default-pink-line">
				...
				<a class="add-address" href="${pageContext.request.contextPath }/address/toaddress"></a>
			</p><br><br>
			<form style="padding-left: 150px;" action="${pageContext.request.contextPath }/address/updateAddress" method="post">
		<div class="address-bar">
		<p>
		<label>收货姓名：</label>
		<input name="addressName" value="${address.addressName }" type="text" id="name"/>
		<span class="red" id="tip1">*</span> 
		<span class="inside-tip"></span>
		</p><br>
		<p data-toggle="distpicker">
			<label>收货地址：</label> 
			<select id="pro" data-province="---- 选择省 ----" name="addressProvice" value="${address.addressProvice }"></select>
			<select id="city" data-city="---- 选择市 ----" name="addressCity" value="${address.addressCity }"></select> 
			<select id="xq" data-district="---- 选择区 ----" name="addressXianqu" value="${address.addressXianqu }"></select> 
			<span class="red">*</span>
		</p> <br>
	<p>
	街道地址：<input type="text" id="diss" name="addressDetail" value="${address.addressDetail }" style="width:320px;"/> <span class="red">*</span><br><br>
	</p><br>
	<p>
	手机号码：<input type="text" name="addressPhone" value="${address.addressPhone }" id="phone"/> <span class="red">*</span><br><br>
	</p><br>
