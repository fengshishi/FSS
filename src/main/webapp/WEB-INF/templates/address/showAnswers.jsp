...
<div class="personal-list-item ml-10 bd-1-e8 fl">
            <ul>
                <li class="list-item active">
                    <div class="userCenter-content">
                        ...
                        <p class="pink-line back-img">
			问答回复内容有效期为&nbsp;3&nbsp;天，超过3天回复内容仅供参考。<a class="i-wanna-cmplt"
				href="${pageContext.request.contextPath }/answers/toanswers"></a>
		</p>
                    </div>
		...
		<tr class="info-title ta-ct">
			...
			<th class="item bb-1-e8" width="15%">问题类型</th>
			<th class="item bb-1-e8" width="15%">问题标题</th>
			<th class="item bb-1-e8" width="20%">问题内容</th>
			<th class="item bb-1-e8" width="55%">提问时间</th>
		</tr>
		<c:forEach items="${requestScope.answersList}" var="answers" varStatus="statu">
		<tr class="info-text ta-ct">
			<td class="item">${statu.count }</td>
			<td class="item">${answers.answersType.antypeName }</td> 
			<td class="item">${answers.answersName }</td>
			<td class="item">${answers.answersContent }</td>
			<td class="item"><fmt:formatDate value="${answers.answersDate }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
		</tr>
		</c:forEach>
		</tbody>
	</table>
