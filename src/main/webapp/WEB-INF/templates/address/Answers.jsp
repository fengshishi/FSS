...
<head>
<meta charset="utf-8">
<title id="www_pc_title">我的收货地址</title>
...
<script type="text/javascript" src="/js/address/answerstype.js"></script>
...
<div class="bc-f5 ht-30 lh-30">
		<div class="wd-1200 ma fs-12 cl-6">
			...
			<p class="fr">
				...
				<a class="hover fr cl-6" href="${pageContext.request.contextPath }/web/index1" target="_blank" title="首页">首页</a>
...
<div class="personal-list-item ml-10 bd-1-e8 fl" id="problem">
            <ul>
                <li class="list-item active">
                    <div class="userCenter-content">
                        <h1 class="blue-line clearfix ">我的问答</h1>
                        <p class="pink-line back-img">问答回复内容有效期为&nbsp;3&nbsp;天，超过3天回复内容仅供参考。
                        <a class="i-wanna-cmplt"></a>
                        </p>
                    
                    <div class="question-form">
		<form action="${pageContext.request.contextPath }/answers/insertanswers" class="rate-holder common-form" method="post" onsubmit="return check()">
			<div class="control-group">
				<label class="control-label">提问类型：</label>
				<select name="answersType.antypeId" id="anstype" style="width: 100px"></select>
			</div><br>
		  <div class="control-group">
				<label class="control-label">提问时间:</label>
				<input name="answersDate" id="dt" type="text" style="width: 300px;" value="${answersDate }" />
			</div><br> 
			<div class="control-group">
				<label for="title" class="control-label">标&nbsp;&nbsp;&nbsp;&nbsp;题：</label>
				<div class="controls">
					<input id="name" data-valid-rule="length(0,31)" data-valid-tip="1-30字" class="newText" type="text" name="answersName"/>
					<span id="tip1" class="pad-bottomie">30字以内</span>
				</div>
			</div>
			<div class="control-group" id="problem1">
				<label class="control-label">提问内容：</label>
				<div class="controls">
					<textarea id="control" data-valid-rule="length(1,2000)" data-valid-tip="1-2000字" name="answersContent"></textarea>
					<span id="tip2" class="pad-bottomie">2000字以内</span>
					<p class="tip">发表评论可以获得购物积分，精彩评论可以获得双倍积分。</p>
				</div>
			</div>
			
			<input type="hidden" name="answers.userId.userId" value="${param.userId}" />
			
			<div class="control-group">
				<!-- <input type="submit" id="button1" value="立即提问"/> -->
				<button class="button1">立即提问</button>
			</div>
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							user_str += '<a class="hover cl-6" href="/download.php" target="_blank" title="下载拾贝APP"><span class="icon-phone-line cl-bl-l fs-16 tp-3 mr-2 pr">&#xe933;</span>下载拾贝APP</a>';
