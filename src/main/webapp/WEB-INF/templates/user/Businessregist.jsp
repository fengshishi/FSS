...
<script type="text/javascript" src="/js/user/business.js"></script>
<script type="text/javascript">
//执行一个laydate实例
laydate.render({
	elem : '#dt',
...
<div class="content">
		<div class="reg-bar-tips mt-25">
			...
			<div class="ht-30 pr">
				<img alt="" src="/images/myimg/bb.PNG"></span>
			</div>
		</div>
	</div>
	...
	<div class="wd-720 mg-a mt-20">
		<form class="reg-frame lh-2p5"
			action="${pageContext.request.contextPath }/business/regist"
			method="post">
			<ul>
				<li>
				...
				<li>
					...
					<div class="fl pr">
						<input class="wd-266 ht-24 lh-24 pd-0406" placeholder="字母a~z或0~9数字组成，长度4~8位"  type="text"
							name="businessName" id="name" value=""> <label id="tip1"></label>
					</div>
					<div class="fl ml-10">
						<p>&nbsp;</p>
					</div>
				...
				<li class="mt-20">
					...
					<div class="fl pr">
						<input class="wd-266 ht-24 lh-24 pd-0406" placeholder="6-16位密码"  type="password"
							name="businessPwd" id="password" value=""> <img
				...
				<li class="mt-20">
					...
					<div class="fl pr">
						<input class="wd-266 ht-24 lh-24 pd-0406"  placeholder="邮箱" type="text"
							name="businessEmail" id="email" value=""> <label
							id="tip3"></label>
					</div>
				...
				<li class="mt-20">
					...
					<div class="fl pr">
						<input class="wd-266 ht-24 lh-24 pd-0406" placeholder="手机号"  type="text"
							name="businessPhone" id="phone" value=""> <label
							id="tip4"></label>
					</div>
					<div class="cb"></div>
				</li>
				...
				<li class="wd-370 ta-ct">
					<button class="reg-btn mt-35 lh-2p4" style="cursor: pointer"
						type="button" id="regist">注册</button>
					<div class="wd-328 ma">
						<p class="ta-rt cl-bl-l" style="cursor: pointer">
							已有账号&nbsp;<a class="cl-bl-l"
								href="${pageContext.request.contextPath}/business/tologin">前往登录</a>
						</p>
					</div>
				</li>
			</ul>
