...
.login-banner-wrap {
	height: 600px;
	background: url(/images/user/c.jpg) no-repeat center;
}
...
<div class="login-banner-wrap">
		<div class="content">
			<div class="login-form ">
				...
				<hr>
				<form action="${pageContext.request.contextPath}/superadmin/login"
					method="post" style="padding-top:70px;">
					<div>
						<span style="color: red;"> ${msg }</span> <input type="text"
							name="superadminName" id="name" value="" placeholder="superadminName" /> <span
					...
					<div>
						<input type="password" name="superadminPwd" id="password" value=""
							placeholder="password" /> <span style="color: red;">*</span>
							<label id="tip2"></label>

					</div>
					<div style="padding-left: 130px; padding-top: 20px;">
						<button class="btn btn-info" style="width: 95px; height: 40px; background-color: #17A2B8;color:#fff;"
							id="login">登录</button>
					</div>
				</form>
			</div>
