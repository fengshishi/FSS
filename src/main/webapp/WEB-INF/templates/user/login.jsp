			...
			<div class="login-form ">
				...
				<div class="row">
					...
					<input type="text" name="userName" id="userName" value=""
						placeholder="username" /> <span style="color: red">*</span>
				</div>
				...
				<a href="${pageContext.request.contextPath}/user/tomodifyPassword"
					style="padding-left: 280px;">修改密码</a>
				<button class="btn btn-info" id="login" style="width: 350px; height: 40px; background-color: #17A2B8; color:#fff;">登录</button>
				<hr>
				<div style="margin-top: 50px;">

					还不是书海拾贝用户？<a
						href="${pageContext.request.contextPath}/user/toregist">立即注册</a>
				</div>
			</div>
		</div>
	</div>
...
.login-banner-wrap {
	height: 600px;
	background: url(/images/user/d.jpg) no-repeat center;
}
