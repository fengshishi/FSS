...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/static/css/modifyuccess.css">
...
<body>
	...
	<div class="cb"></div>
<div style="text-align:center; height:400px;background-image: url(/images/user/5.jpg); margin-top:15px;">
	<h2>修改密码成功</h2>
	<h3>
		${msg }<br> <a
			href="${pageContext.request.contextPath }/user/tologin">请重新登录</a>
	</h3>
</div>
	<!-- 底部 -->
